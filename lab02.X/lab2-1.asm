...
setup1:
    ...
    MOVLW 0x06
    MOVWF 0x20 ; Use 0x20 as loop counter

loop1:
    ; Set [INDF0 + 1] = [INDF0] + [INDF1]
    MOVFF POSTINC0, W ; Load [INDF0] into W and increment FSR0
    ADDWF INDF1, W ; Add [INDF1] to W
    MOVFF W, INDF0 ; Store result in [INDF0] and increment FSR0

    ; INDF0++ (already done by POSTINC0 above)

    ; Set [INDF1] = [INDF0] + [INDF1]
    MOVFF INDF0, W ; Load [INDF0] into W
    ADDWF POSTDEC1, W ; Add [INDF1] to W
    MOVFF W, INDF1 ; Store result in [INDF1]
