...
FINAL_IMAGE=${DISTDIR}/midterm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/midterm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F4520
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/midterm.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/midterm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F4520 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/midterm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
